...
import { chatWithLoveAppSSE, generateChatId } from '../services/api'
  ...
  setup() {
    ...
    const addWelcomeMessage = () => {
      const welcomeMessage = {
        id: Date.now(),
        type: 'ai-message',
        text: '你好！我是AI恋爱大师，专门帮助解决恋爱问题。无论是表白技巧、约会建议还是感情困惑，我都可以为你提供专业的建议。请告诉我你遇到的问题吧！💕',
    ...
    const sendMessage = async () => {
      ...
      try {
        // 建立SSE连接
        currentEventSource.value = chatWithLoveAppSSE(
          messageToSend,
          chatId.value,
          handleSSEMessage,
          handleSSEError,
